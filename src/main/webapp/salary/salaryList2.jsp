...
//1 요청 분석
	...
	while(rsSelect.next()) { // ResultSet의 API를 모른다면 사용할 수 없는 반복문
		...
		map.put("firstName", rsSelect.getString("e.first_name"));
		map.put("lastName", rsSelect.getString("e.last_name"));
		...
		<table class = "table table-hover" style = "background-color : rgb(255,255,255)">	
			...
			%>
				<tr>
					...
					<td class = "center"><%=map.get("firstName")%></td>
					<td class = "center"><%=map.get("lastName")%></td>
